        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 text-end mb-3">
                    <a href="{{ route('admin-ekstrakulikuler.create') }}" class="btn btn-success"><i class='bx bx-plus-circle'
            ...
            <table class="table table-striped datatable">
                <thead>
                    <tr>
                        ...
                        <th>Foto</th>
                        <th>Nama Kegiatan</th>
                        <th>Berapa kali/Minggu</th>
                        <th>Berapa Jam/Periode</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody class="table-border-bottom-0">
                    @foreach ($ekstrakulikuler as $index => $item)
                        <tr>
                            ...
                            <td><img src="{{ url('assets/img/ekstrakulikuler/' . $item->image) }}"
                                    alt="Image-Ekstrakulikuler" height="100px">
                            </td>
                            <td>{{ $item->nama_ekstrakulikuler }}</td>
                            <td>{{ $item->waktu_per_minggu }}</td>
                            <td>{{ $item->jam_per_periode }}</td>
