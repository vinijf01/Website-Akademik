        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 text-end mb-3">
                    <a href="{{ route('admin-image-fasilitas.create') }}" class="btn btn-success"><i class='bx bx-plus-circle'
        ...
        <div class="table-responsive text-nowrap p-3">
            <table class="table table-striped datatable">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($image_fasilitas as $index => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin-image-fasilitas.edit', $item->id) }}">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('admin-image-fasilitas.destroy', $item->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
