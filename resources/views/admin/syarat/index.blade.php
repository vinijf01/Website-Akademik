        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 text-end mb-3">
                    <a href="{{ route('admin.ppdb-syarat.create') }}" class="btn btn-success"><i class='bx bx-plus-circle'
        ...
        <div class="table-responsive text-nowrap p-3">
            <table class="table table-striped datatable">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($syarat_ppdb as $index => $item)
                        <tr>
                            <th class="text-center" scope="row">{{ $index + 1 }}</th>
                            <td>{{ $item->syarat }}</td>
                            <td>
                                <a href="{{ route('admin.ppdb-syarat.edit', $item->id) }}">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('admin.ppdb-syarat.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
